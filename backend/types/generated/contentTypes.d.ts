...
export interface ApiLandingPageLandingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['landing-page.image-item', 'landing-page.images-grid']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductVariantProductVariant
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    price_override: Schema.Attribute.Decimal;
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    sizes: Schema.Attribute.Component<'product.size-availability', true>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    care_instruction: Schema.Attribute.RichText;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    product_info: Schema.Attribute.RichText;
...
export interface ApiVariantSizeVariantSize extends Struct.CollectionTypeSchema {
  collectionName: 'variant_sizes';
  info: {
    displayName: 'Variant Size';
    pluralName: 'variant-sizes';
    singularName: 'variant-size';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::variant-size.variant-size': ApiVariantSizeVariantSize;
